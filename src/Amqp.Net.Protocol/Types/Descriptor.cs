...
public static class Descriptor
{
    ...
    /// </summary>
    public static bool IsPerformative(ulong descriptor)
    {
        return descriptor is >= Open and <= Close;
    }

    /// <summary>
    /// Checks if a descriptor is a delivery state.
    /// </summary>
    public static bool IsDeliveryState(ulong descriptor)
    {
        return descriptor is >= Received and <= Modified or TransactionalState or Declared;
    }

    /// <summary>
    /// Checks if a descriptor is a message section.
    /// </summary>
    public static bool IsMessageSection(ulong descriptor)
    {
        return descriptor is >= Header and <= Footer;
    }

    /// <summary>
    /// Checks if a descriptor is a SASL frame body.
    /// </summary>
    public static bool IsSaslFrame(ulong descriptor)
    {
        return descriptor is >= SaslMechanisms and <= SaslOutcome;
    }
}
